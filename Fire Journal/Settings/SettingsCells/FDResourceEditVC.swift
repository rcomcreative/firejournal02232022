//
//  FDResourceEditVC.swift
//  Fire Journal
//
//  Created by DuRand Jones on 10/11/19.
//  Copyright © 2020 PureCommand, LLC. All rights reserved.
//

import UIKit

protocol FDResourceEditVCDelegate: AnyObject {
    func theCancelButtonTapped()
    func theSaveResourceTapped(resource: UserFDResources)
}

class FDResourceEditVC: UIViewController {
    //    MARK: -Objects-
    ...
    //    MARK: -Properties-
    weak var delegate: FDResourceEditVCDelegate? = nil
...
//        resourceNameTF.text = name
    ...
    @IBAction func saveBTapped(_ sender: Any) {
        delegate?.theSaveResourceTapped(resource: fdResources!)
    }
    @IBAction func cancelBTapped(_ sender: Any) {
        delegate?.theCancelButtonTapped()
    }

//
//  SettingMyResourcePhoneTVCell.swift
//  DashboardTest
//
//  Created by DuRand Jones on 2/15/20.
//  Copyright © 2020 PureCommand, LLC. All rights reserved.
//

import UIKit

protocol SettingMyResourcePhoneTVCellDelegate: AnyObject {
    func phoneEditBTapped(row: Int)
}

class SettingMyResourcePhoneTVCell: UITableViewCell {
    ...
    weak var delegate: SettingMyResourcePhoneTVCellDelegate? = nil
    ...
    @IBAction func editBTapped(_ sender: Any) {
        delegate?.phoneEditBTapped(row: row)
       }

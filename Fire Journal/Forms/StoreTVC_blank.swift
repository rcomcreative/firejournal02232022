...
protocol StoreTVCDelegate: AnyObject {
    func storeTapped()
}

class StoreTVC_blank: UITableViewController {
    //    TODO: -Remove from app
    weak var delegate:StoreTVCDelegate? = nil

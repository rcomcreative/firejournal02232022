...
protocol NFIRSBasic1FormTVCDelegate: AnyObject {
    func nfirsTapped()
}

class NFIRSBasic1FormTVC: UITableViewController {
    weak var delegate:NFIRSBasic1FormTVCDelegate? = nil
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            cell.controllerL.text = "NFIRS Basic 1"

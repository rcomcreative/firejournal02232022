//
//  RelieveSupervisorContactsTVC.swift
//  Fire Journal
//
...
protocol RelieveSupervisorContactsTVCDelegate: AnyObject {
    func cancelContactsBTapped()
    func saveContactsBTapped(crew: [CrewFromContact] )
}

class RelieveSupervisorContactsTVC: UITableViewController {
    
    weak var delegate: RelieveSupervisorContactsTVCDelegate? = nil
...
extension RelieveSupervisorContactsTVC: RelieveSupervisorContactsHeaderVDelegate {
    
    func relieveSupervisorContactsSaveBTapped() {
        self.dismiss(animated: true, completion: nil)
        delegate?.saveContactsBTapped(crew: selected )
    }

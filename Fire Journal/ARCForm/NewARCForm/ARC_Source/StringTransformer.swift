...
class StringTransformer: NSSecureUnarchiveFromDataTransformer {
...
extension StringTransformer {
    
    static let name = NSValueTransformerName(rawValue: String(describing: StringTransformer.self ))

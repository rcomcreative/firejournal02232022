//
//  ICS214NewIncidentVC+Extensions.swift
//  Fire Journal
//
...
extension ICS214NewIncidentVC: ModalHeaderSaveDismissDelegate {
    ...
    func modalDismiss() {
        ...
        delegate?.ics214IncidentNewCancelled()
    }
    ...
    func modalSave(myShift: MenuItems) {
        ...
        if theIncident.locationAvailable, theIncident.incidentNumber != "" {
            ...
            do {
                ...
                delegate?.ics214IncidentNewSaved(objectID: objectID)
            } catch let error as NSError {
                let nserror = error
...
extension ICS214NewIncidentVC: UITableViewDelegate {
...
extension ICS214NewIncidentVC: UITableViewDataSource {
...
extension ICS214NewIncidentVC: LabelDateiPhoneTVCellDelegate {
...
extension ICS214NewIncidentVC: NewAddressFieldsButtonsCellDelegate {
...
extension ICS214NewIncidentVC: OnBoardAddressSearchDelegate {
...
extension ICS214NewIncidentVC: SegmentCellDelegate {
...
extension ICS214NewIncidentVC: LabelSingleDateFieldCellDelegate {
...
extension ICS214NewIncidentVC: LabelTextFieldCellDelegate {
...
extension ICS214NewIncidentVC: LabelYesNoSwitchCellDelegate {
